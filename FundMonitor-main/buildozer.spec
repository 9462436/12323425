...
requirements = python3,flask,requests,kivy,openssl
...
# (list) Pattern to exclude from the result. A pattern is a 'match'
# which evaluates to True if the file should be excluded
#android.exclude_patterns = license,images/*/*.jpg

# (bool) Support for allow_backup (default is True)
...
# Control the inclusion of specific python libraries
#p4a.whitelist =
